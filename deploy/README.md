...
- **Сразу зарегистрируйтесь на сайте**: первый аккаунт автоматически получает
  панель управления (`/admin`). Все следующие регистрации — обычные покупатели,
  так что не тяните с первым входом
